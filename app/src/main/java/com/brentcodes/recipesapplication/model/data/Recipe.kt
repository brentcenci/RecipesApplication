...
data class Recipe(
    ...
    @SerializedName("calories") var calories: Float? = null,
    @SerializedName("glycemicIndex") var glycemicIndex: Int? = null,
    @SerializedName("totalCO2Emissions") var totalCO2Emissions: Float? = null,
    @SerializedName("co2EmissionsClass") var co2EmissionsClass: String? = null,
    @SerializedName("totalWeight") var totalWeight: Float? = null,
